...
#ifndef PROJECT_BASE_V1_1_2_RISCV_HPP
#define PROJECT_BASE_V1_1_2_RISCV_HPP
#include "../lib/hw.h"
#include "codes.hpp"
class Riscv
{
public:
    ...
    static void disable_external_interrupts();
    // write register sip
...
inline void Riscv::enable_external_interrupts(){
    uint64 t=1<<9;
...
#endif //PROJECT_BASE_V1_1_2_RISCV_HPP
